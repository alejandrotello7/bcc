...
#
# writesnoop: Trace write() syscalls for a specific process.
...
parser = argparse.ArgumentParser(
    description="Trace write() syscalls for a specific process",
...
bpf_text_kprobe_body = """
    ...
    bpf_probe_read_user_str(&data.name, sizeof(data.name), (void *)buf);
    data.ret = count;
